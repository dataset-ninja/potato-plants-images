...
##################################
PROJECT_NAME: str = "Potato Plants Images"
...
PREVIEW_IMAGE_ID: int = 1741119
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/potato-plants-images"
...
AUTHORS: Optional[List[str]] = ["Aleksandar Vakanski"]

ORGANIZATION_NAME: Optional[Union[str, List[str]]] = "University of Idaho"
